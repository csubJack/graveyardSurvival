//
//program: fullscreen-asteroids.cpp
...
void check_mouse(XEvent *e, X11_wrapper *x11)
{
	...
	if (savex != e->xbutton.x || savey != e->xbutton.y) {
		...
		//std::flush;
		// mouse cursor on means mouse does not control ship thrust.
		// mouse is a regular mouse.
...
int check_keys(XEvent *e)
{
	...
	switch (key) {
		...
		case XK_m:
			...
			//we can use logical not to toggle an integer.
